...
public class RequestsController extends BaseResource {
    ...
    private Response getRequestById (@PathParam("requestId") String requestId) {
        try {
            ...
            QueryCriteria queryCriteria = new QueryCriteria.LinearStateQueryCriteria(null, Collections.singletonList(UUID.fromString(requestId)), null, Vault.StateStatus.UNCONSUMED);
    ...
    private Response createRequest (@Valid @RequestBody Request request) {
        try {
            ...
            List<AbstractParty> participants = Arrays.asList(Catan_MoFA,US_DoJ, US_DoS, US_CSO, NewAmerica, Catan_MoJ, Catan_Treasury, Catan_CSO);
